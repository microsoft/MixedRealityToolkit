...
void UDPProxyClient::PingServerGroup::SendPingedServersToCoordinator(RakPeerInterface *peerInterface)
/// MICROSOFT PROJECT B CHANGES END
{
	...
	/// MICROSOFT PROJECT B CHANGES BEGIN
	peerInterface->Send(&outgoingBs, MEDIUM_PRIORITY, RELIABLE_ORDERED, 0, coordinatorAddressForPings, false);
	/// MICROSOFT PROJECT B CHANGES END
}
