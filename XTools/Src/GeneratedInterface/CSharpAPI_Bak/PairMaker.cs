...
public class PairMaker : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_PairMaker(swigCPtr);
        }
  ...
  public virtual bool IsReceiver() {
    bool ret = (SwigDerivedClassHasMethod("IsReceiver", swigMethodTypes0) ? XToolsClientPINVOKE.PairMaker_IsReceiverSwigExplicitPairMaker(swigCPtr) : XToolsClientPINVOKE.PairMaker_IsReceiver(swigCPtr));
    return ret;
  }

  public virtual int GetAddressCount() {
    int ret = XToolsClientPINVOKE.PairMaker_GetAddressCount(swigCPtr);
    return ret;
  }

  public virtual XString GetAddress(int index) {
    global::System.IntPtr cPtr = (SwigDerivedClassHasMethod("GetAddress", swigMethodTypes2) ? XToolsClientPINVOKE.PairMaker_GetAddressSwigExplicitPairMaker(swigCPtr, index) : XToolsClientPINVOKE.PairMaker_GetAddress(swigCPtr, index));
    XString ret = (cPtr == global::System.IntPtr.Zero) ? null : new XString(cPtr, true);
    return ret; 
  }

  public virtual ushort GetPort() {
    ushort ret = (SwigDerivedClassHasMethod("GetPort", swigMethodTypes3) ? XToolsClientPINVOKE.PairMaker_GetPortSwigExplicitPairMaker(swigCPtr) : XToolsClientPINVOKE.PairMaker_GetPort(swigCPtr));
    return ret;
  }

  public virtual void Update() {
    if (SwigDerivedClassHasMethod("Update", swigMethodTypes4)) XToolsClientPINVOKE.PairMaker_UpdateSwigExplicitPairMaker(swigCPtr); else XToolsClientPINVOKE.PairMaker_Update(swigCPtr);
  }

  public virtual bool IsReadyToConnect() {
    bool ret = (SwigDerivedClassHasMethod("IsReadyToConnect", swigMethodTypes5) ? XToolsClientPINVOKE.PairMaker_IsReadyToConnectSwigExplicitPairMaker(swigCPtr) : XToolsClientPINVOKE.PairMaker_IsReadyToConnect(swigCPtr));
    return ret;
  }

  public virtual int GetLocalKey() {
    int ret = (SwigDerivedClassHasMethod("GetLocalKey", swigMethodTypes6) ? XToolsClientPINVOKE.PairMaker_GetLocalKeySwigExplicitPairMaker(swigCPtr) : XToolsClientPINVOKE.PairMaker_GetLocalKey(swigCPtr));
    return ret;
  }

  public virtual int GetRemoteKey() {
    int ret = (SwigDerivedClassHasMethod("GetRemoteKey", swigMethodTypes7) ? XToolsClientPINVOKE.PairMaker_GetRemoteKeySwigExplicitPairMaker(swigCPtr) : XToolsClientPINVOKE.PairMaker_GetRemoteKey(swigCPtr));
    return ret;
  }

  public PairMaker() : this(XToolsClientPINVOKE.new_PairMaker(), true) {
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    XToolsClientPINVOKE.PairMaker_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7);
  }
