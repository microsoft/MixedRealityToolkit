...
public class DiscoveryClientListener : Listener {
  ...
  internal DiscoveryClientListener(global::System.IntPtr cPtr, bool cMemoryOwn) : base(XToolsProfilerPINVOKE.DiscoveryClientListener_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsProfilerPINVOKE.delete_DiscoveryClientListener(swigCPtr);
        }
  ...
  public virtual void OnRemoteSystemDiscovered(DiscoveredSystem remoteSystem) {
    if (SwigDerivedClassHasMethod("OnRemoteSystemDiscovered", swigMethodTypes0)) XToolsProfilerPINVOKE.DiscoveryClientListener_OnRemoteSystemDiscoveredSwigExplicitDiscoveryClientListener(swigCPtr, DiscoveredSystem.getCPtr(remoteSystem)); else XToolsProfilerPINVOKE.DiscoveryClientListener_OnRemoteSystemDiscovered(swigCPtr, DiscoveredSystem.getCPtr(remoteSystem));
  }

  public virtual void OnRemoteSystemLost(DiscoveredSystem remoteSystem) {
    if (SwigDerivedClassHasMethod("OnRemoteSystemLost", swigMethodTypes1)) XToolsProfilerPINVOKE.DiscoveryClientListener_OnRemoteSystemLostSwigExplicitDiscoveryClientListener(swigCPtr, DiscoveredSystem.getCPtr(remoteSystem)); else XToolsProfilerPINVOKE.DiscoveryClientListener_OnRemoteSystemLost(swigCPtr, DiscoveredSystem.getCPtr(remoteSystem));
  }

  public DiscoveryClientListener() : this(XToolsProfilerPINVOKE.new_DiscoveryClientListener(), true) {
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    XToolsProfilerPINVOKE.DiscoveryClientListener_director_connect(swigCPtr, swigDelegate0, swigDelegate1);
  }
