...
public class LogWriter : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsProfilerPINVOKE.delete_LogWriter(swigCPtr);
        }
  ...
  public virtual void WriteLogEntry(LogSeverity severity, string message) {
    if (SwigDerivedClassHasMethod("WriteLogEntry", swigMethodTypes0)) XToolsProfilerPINVOKE.LogWriter_WriteLogEntrySwigExplicitLogWriter(swigCPtr, (int)severity, message); else XToolsProfilerPINVOKE.LogWriter_WriteLogEntry(swigCPtr, (int)severity, message);
    if (XToolsProfilerPINVOKE.SWIGPendingException.Pending) throw XToolsProfilerPINVOKE.SWIGPendingException.Retrieve();
  }

  public LogWriter() : this(XToolsProfilerPINVOKE.new_LogWriter(), true) {
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    XToolsProfilerPINVOKE.LogWriter_director_connect(swigCPtr, swigDelegate0);
  }
