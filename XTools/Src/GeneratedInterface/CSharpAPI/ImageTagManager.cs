...
public class ImageTagManager : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_ImageTagManager(swigCPtr);
        }
  ...
  public virtual void Update() {
    XToolsClientPINVOKE.ImageTagManager_Update(swigCPtr);
  }
  ...
  public unsafe bool FindTags(byte[] data, int pixelWidth, int pixelHeight, int bytesPerPixel, ImageTagLocationListener locationCallback) {
    ...
    {
      bool ret = XToolsClientPINVOKE.ImageTagManager_FindTags(swigCPtr, (global::System.IntPtr)swig_ptrTo_data, pixelWidth, pixelHeight, bytesPerPixel, ImageTagLocationListener.getCPtr(locationCallback));
      return ret;
    }
    }
  }
  ...
  public virtual TagImage CreateTagImage(int tagId) {
    global::System.IntPtr cPtr = XToolsClientPINVOKE.ImageTagManager_CreateTagImage(swigCPtr, tagId);
    TagImage ret = (cPtr == global::System.IntPtr.Zero) ? null : new TagImage(cPtr, true);
    return ret; 
  }

  public static ImageTagManager Create() {
    global::System.IntPtr cPtr = XToolsClientPINVOKE.ImageTagManager_Create();
