...
public class UserPresenceManagerListener : Listener {
  ...
  internal UserPresenceManagerListener(global::System.IntPtr cPtr, bool cMemoryOwn) : base(XToolsClientPINVOKE.UserPresenceManagerListener_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_UserPresenceManagerListener(swigCPtr);
        }
  ...
  public virtual void OnUserPresenceChanged(User user) {
    if (SwigDerivedClassHasMethod("OnUserPresenceChanged", swigMethodTypes0)) XToolsClientPINVOKE.UserPresenceManagerListener_OnUserPresenceChangedSwigExplicitUserPresenceManagerListener(swigCPtr, User.getCPtr(user)); else XToolsClientPINVOKE.UserPresenceManagerListener_OnUserPresenceChanged(swigCPtr, User.getCPtr(user));
  }

  public UserPresenceManagerListener() : this(XToolsClientPINVOKE.new_UserPresenceManagerListener(), true) {
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    XToolsClientPINVOKE.UserPresenceManagerListener_director_connect(swigCPtr, swigDelegate0);
  }
