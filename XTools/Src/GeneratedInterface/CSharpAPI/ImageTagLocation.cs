...
public class ImageTagLocation : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_ImageTagLocation(swigCPtr);
        }
  ...
  public virtual int GetTagId() {
    int ret = XToolsClientPINVOKE.ImageTagLocation_GetTagId(swigCPtr);
    return ret;
  }

  public virtual float GetPixelX(ImageTagLocationType locationType) {
    float ret = XToolsClientPINVOKE.ImageTagLocation_GetPixelX(swigCPtr, (int)locationType);
    return ret;
  }

  public virtual float GetPixelY(ImageTagLocationType locationType) {
    float ret = XToolsClientPINVOKE.ImageTagLocation_GetPixelY(swigCPtr, (int)locationType);
    return ret;
  }

  public virtual float GetModelViewMatrix(int row, int col, float F, float G, float A, float B, float C, float D) {
    float ret = XToolsClientPINVOKE.ImageTagLocation_GetModelViewMatrix(swigCPtr, row, col, F, G, A, B, C, D);
    return ret;
  }
