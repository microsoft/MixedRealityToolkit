...
public class PairingListener : Listener {
  ...
  internal PairingListener(global::System.IntPtr cPtr, bool cMemoryOwn) : base(XToolsClientPINVOKE.PairingListener_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_PairingListener(swigCPtr);
        }
  ...
  public virtual void PairingConnectionSucceeded() {
    if (SwigDerivedClassHasMethod("PairingConnectionSucceeded", swigMethodTypes0)) XToolsClientPINVOKE.PairingListener_PairingConnectionSucceededSwigExplicitPairingListener(swigCPtr); else XToolsClientPINVOKE.PairingListener_PairingConnectionSucceeded(swigCPtr);
  }

  public virtual void PairingConnectionFailed(PairingResult reason) {
    if (SwigDerivedClassHasMethod("PairingConnectionFailed", swigMethodTypes1)) XToolsClientPINVOKE.PairingListener_PairingConnectionFailedSwigExplicitPairingListener(swigCPtr, (int)reason); else XToolsClientPINVOKE.PairingListener_PairingConnectionFailed(swigCPtr, (int)reason);
  }

  public PairingListener() : this(XToolsClientPINVOKE.new_PairingListener(), true) {
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    XToolsClientPINVOKE.PairingListener_director_connect(swigCPtr, swigDelegate0, swigDelegate1);
  }
