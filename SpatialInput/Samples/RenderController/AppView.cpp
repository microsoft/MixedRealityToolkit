...
{
    applicationView.Activated(bind(&AppView::OnViewActivated, this, _1, _2));
    ...
    m_main = std::make_unique<ControllerRenderSampleMain>(m_deviceResources);
}
...
void AppView::OnLaunched(LaunchActivatedEventArgs const& args)
{
    ...
    {
        // Insert code to preload resources here.
    }
}
