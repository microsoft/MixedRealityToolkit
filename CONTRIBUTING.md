...
Instead, start by [opening an issue](https://github.com/Microsoft/HoloToolkit/issues) describing the problem you want to solve and how you plan to approach the problem. 
...
Start a GitHub pull request to merge your topic branch into the [main repository's master branch](https://github.com/Microsoft/HoloToolkit/tree/master). 
