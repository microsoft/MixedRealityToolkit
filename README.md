...
The provided XAML demo app is a uses the embedded callback method. It shows how to use the raw data from the microphone and also how to record wav files. https://github.com/Microsoft/HoloToolkit-Unity/Assets/HoloToolkit/Input/Scripts/Microphone/MicStreamDemo.cs has an alternate example showing how to use this library inside of Unity. 
...
Fills buffer of length and numchannels to the app. This is how Unity3d and Unreal will want to access audio data -- from a poll in the game engine's audio engine. This is used in the example from https://github.com/Microsoft/HoloToolkit-Unity/Assets/HoloToolkit/Input/Scripts/Microphone/MicStreamDemo.cs
